        ...
        <div className="container-custom py-12">
          <div className="text-center mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-neutral-300 body-base">
              ...
              <a href="mailto:zachriley36@gmail.com" className="text-primary-400 hover:text-primary-300 transition-colors">
                ✉️ ZachRiley36@gmail.com
              </a>
              <a href="https://linkedin.com/in/zdriley" className="text-primary-400 hover:text-primary-300 transition-colors" target="_blank" rel="noopener noreferrer">
                🔗 LinkedIn
              </a>
            </div>
          </div>
      ...
      <div className="container-custom py-16 space-y-16">
        ...
        <section className="animate-slide-up">
          ...
          <div className="space-y-8">
            {/* Digital Democracy */}
            <div className="bg-neutral-800/50 border border-neutral-700 rounded-xl p-8 hover:bg-neutral-800/70 transition-all duration-300">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="heading-sm text-white mb-1">Software Engineering Student Fellow</h3>
                  <p className="text-primary-300 font-medium">Digital Democracy | CalMatters</p>
                </div>
            ...
            <div className="bg-neutral-800/50 border border-neutral-700 rounded-xl p-8 hover:bg-neutral-800/70 transition-all duration-300">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  ...
                  <p className="text-primary-300 font-medium">Amazon</p>
                </div>
        ...
        <section className="animate-slide-up">
          ...
          <div className="bg-neutral-800/50 border border-neutral-700 rounded-xl p-8">
            <div className="mb-6">
              ...
              <p className="text-primary-300 font-medium mb-1">B.S. in Computer Science, Minor in Philosophy</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-primary-500 pl-6">
                    <h5 className="text-primary-300 font-medium mb-2">Representing Financial Transactions of the California Legislature</h5>
                  ...
                  <div className="border-l-4 border-primary-500 pl-6">
                    <h5 className="text-primary-300 font-medium mb-2">Is Ultimate Frisbee Coverage Biased?</h5>
                    <p className="text-neutral-300 body-base">
